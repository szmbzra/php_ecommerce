...
<body>
  ...
  <section id="brand" class="container mt-5 pt-5">
    <div class="row">
      <img src="assets/imgs/logo.png" alt="" class="img-fluid col-lg-3 col-md-6 col-sm-12">
      <img src="assets/imgs/logo.png" alt="" class="img-fluid col-lg-3 col-md-6 col-sm-12">
      <img src="assets/imgs/logo.png" alt="" class="img-fluid col-lg-3 col-md-6 col-sm-12">
      <img src="assets/imgs/logo.png" alt="" class="img-fluid col-lg-3 col-md-6 col-sm-12">
    </div>
  ...
  <!-- new -->
  <section id="new" class="w-100 pt-5 mt-5">
    <div class="row p-0 m-0">
      <!-- one -->
      <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
        <img src="assets/imgs/logo.png" alt="" class="img-fluid">
        <div class="details">
          <h2>Extreme Awesoe Shoes</h2>
...
<?php  while($row = $featured_products->fetch_assoc()){?>
      ...
      <a href="<?php echo "single_product.php?product_id=". $row['product_id'];?>"><button class="buy-btn">Buy Now sam</button></a>
      </div>
<?php } ?>
  ...
  <section id="banner" class="my-5 py-5">
    <div class="container">
      ...
      <h1>Autmn Collection<br>UP to 30% Off</h1>
      <button class="text-uppercase">Shop Now</button>
    </div>
  </section>
  <!-- clothes -->
  <section id="featured" class="my-5">
    <div class="container text-center mt-5 py-5">
      <h3>Dresses & Coats</h3>
      <hr class="mx-auto">
      <p>HHere you can check our amazing clothes</p>
    </div>
    <div class="row mx-auto container-fluid">
  ...
  <section id="shoes" class="my-5">
    <div class="container text-center mt-5 py-5">
      <h3>Shoes</h3>
      <hr class="mx-auto">
      <p>HHere you can check our amazing Shoes</p>
    </div>
    <div class="row mx-auto container-fluid">
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
